...
CUDA_VISIBLE_DEVICES=1 nohup python -u ../sheeprl.py exp=p2e_dv3_exploration_ppo \
                     env=unity_env \
                     env.num_envs=4 \
                     ...
                     buffer.size=100000 \
                     env.wrapper.file_name=/home/calm04/data/sheeprl/unity_env/240809_agent/240809_agent.x86_64 \
                     > "${SCRIPT_NAME}.log" 2>&1 &
